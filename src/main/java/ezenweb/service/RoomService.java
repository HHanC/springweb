...
//                String dir  = "C:\\Users\\505-t\\Desktop\\springweb\\ezen_web_2022_A_springweb\\src\\main\\resources\\static\\upload\\";
                ...
                String dir = "C:\\Users\\504\\Desktop\\springweb\\src\\main\\resources\\static\\upload\\";
    ...
    public // 접근제한자
        ...
        ( Map<String,String> Location ) // 인수
     {
        ...
        if(trans == 0){
            roomEntityList = roomRepository.search(minprice, maxprice); // 전체 검색
        }else{
            roomEntityList = roomRepository.search(trans, minprice, maxprice);
        }
